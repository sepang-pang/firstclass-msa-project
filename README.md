...
| **기능**                     | **HTTP Method** | **엔드포인트**                 | **설명**              |
|----------------------------|-----------------|---------------------------|---------------------|
| **허브 생성**            | `POST`           | `/hubs` | 허브 정보를 받아 허브 생성 |
| **허브 검색**         | `GET`           | `/hubs` | 조건별 허브 검색 |
| **허브 수정**                  | `PUT`        | `/hubs`       | 특정 허브 정보 수정  |
| **허브 삭제** | `DELETE`           | `/hubs`  | 특정 허브 정보 삭제 |
<br>

- hub-transition-info-service

| **기능**                     | **HTTP Method** | **엔드포인트**                 | **설명**              |
|----------------------------|-----------------|---------------------------|---------------------|
| **허브 간 이동정보 생성**            | `POST`           | `/hub-transit-infos` | 두 허브 간 정보를 입력 받아 허브 간 이동 정보 생성 |
| **허브 간 이동정보 조회**         | `GET`           | `/hub-transit-infos` | 두 허브 간 최적 경로를 다익스트라 알고리즘으로 탐색 |
| ***허브 간 이동정보 수정**                  | `PUT`        | `/hub-transit-infos`       | 특정 허브 간 이동 정보 수정   |
| **허브 간 이동정보 삭제** | `DELETE`           | `/hub-transit-infos`  | 특정 허브 간 이동 정보 삭제 |
<br>
...
| **기능**                     | **HTTP Method** | **엔드포인트**                 | **설명**              |
|----------------------------|-----------------|---------------------------|---------------------|
| **업체 생성**            | `POST`           | `/business` | 업체 정보를 받아 신규 업체 생성 |
| **업체 검색**         | `GET`           | `/business` | 조건별 업체 검색 (이름, 주소 등) |
| **업체 수정**                  | `PUT`        | `/business/{businessId}`       | 특정 업체 정보 수정   |
| **업체 삭제** | `DELETE`           | `/business/{businessId}`  | 특정 업체 정보 삭제 |
<br>
...
| **기능**                     | **HTTP Method** | **엔드포인트**                 | **설명**              |
|----------------------------|-----------------|---------------------------|---------------------|
| **상품 생성**            | `POST`           | `/products` | 상품 정보를 받아 상품 생성 |
| **상품 검색**         | `GET`           | `/products` | 조건별 상품 검색 (이름, 가격 등) |
| **상품 수정**                  | `PUT`        | `/products/{productId}`       | 특정 상품 정보 수정   |
| **상품 삭제** | `DELETE`           | `/products/{productId}`  | 특정 상품 정보 삭제 |
<br>
